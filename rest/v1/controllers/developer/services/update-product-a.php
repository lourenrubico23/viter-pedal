...
if (isset($_SERVER['HTTP_AUTHORIZATION'])) {
  ...
  if (array_key_exists("servicesid", $_GET)) {
    ...
    $services->services_product_a = checkIndex($data, "services_product_a");
    $services->services_description_a = checkIndex($data, "services_description_a");
    $services->services_button_text_a = checkIndex($data, "services_button_text_a");
