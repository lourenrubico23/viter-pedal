...
const ModalAddServices2 = ({itemEdit, setIsServices2}) => {
  ...
  const initVal = {
    services_img_2: itemEdit ? itemEdit?.data[0].services_img_2 : "",
  };
      ...
      <div className="modal-content">
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            const data = {
              ...values,
              services_img_2: photo?.name || itemEdit.services_img_2,
            };
                ...
                <div className="form-input">
                  <div className="mt-5">
                    ...
                    <div className="relative w-fit m-auto group">
                      ...
                      ) : (itemEdit?.services_img_2 === "" && photo === null) ||
                        photo === "" ? (
                        ...
                        <img
                          src={
                            photo
                              ...
                              : devBaseImgUrl + "/" + itemEdit?.services_img_2 // check db
                          }
                          alt="Logo"
                      ...
                      <div className="btnImgUpload">
                        <button>
                          ...
                          <InputPhotoUpload
                            ...
                            title="Upload Logo"
                            onChange={(e) =>
                              handleChangePhoto(e, initVal.services_img_2)
                            }
                    ...
                    <button
                      ...
                      disabled={
                        ((mutation.isPending || !props.dirty) &&
                          photo === null) ||
                        photo === "" ||
                        initVal.services_img_2 === photo?.name
                      }
                    >
                      {mutation.isPending ? (
                        <ButtonSpinner />
...
export default ModalAddServices2
