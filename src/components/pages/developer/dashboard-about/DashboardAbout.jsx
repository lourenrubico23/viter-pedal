      ...
      <div>
        <div className="discover_wrapper">
          <div className="lg:flex lg:flex-row-reverse lg:relative md:w-[100%] ">
            ...
            <a
              className="absolute z-30 m-10 right-[650px] -top-14 cursor-pointer tooltip-action-table"
              data-tooltip="Upload"
            >
              <MdFileUpload className=" bg-accent rounded-full w-[25px] h-[25px] p-1 " />
            </a>
        ...
        <div className="discover_wrapper lg:flex lg:flex-row-reverse lg:relative md:w-[100%]">
          <div className="lg:absolute lg:right-0 lg:top-0 h-full lg:w-[50%] block relative">
            <a
              className="absolute z-30 m-10 right-[30px] cursor-pointer tooltip-action-table"
              data-tooltip="Upload"
            >
              <MdFileUpload className=" bg-accent rounded-full w-[25px] h-[25px] p-1 " />
            </a>
          ...
          <div className="container_dashboard">
            <div className="lg:grid lg:grid-cols-2 lg:mr-20 lg:pr-10 ">
              <div className="dicover flex flex-col gap-4 py-7 lg:gap-0 md:my-6 relative">
                <a
                  className="absolute z-30 m-10 right-[300px] cursor-pointer tooltip-action-table"
                  data-tooltip="Upload"
                >
                  <MdFileUpload className=" bg-accent rounded-full w-[25px] h-[25px] p-1 " />
                </a>
