                ...
                <div className="lg:grid lg:grid-cols-2">
                  ...
                  <div className="dicover flex flex-col gap-4 lg:my-20 lg:ml-20 relative">
                    ...
                    <p className="py-2 md:font-bold md:leading-6 text-[clamp(6vw,16px)]">
                      Biking refers to the activity of riding a bicycle, which
                      is a pedal-driven, two-wheeled vehicle. It's a popular
                      form of transportation, recreation, and exercise that
                      involves using leg power to propel the bike forward.
                      Biking can be done on various types of terrain, including
                      roads, trails, and off-road paths, and it offers numerous
                    ...
                    <div className="md:my-5 relative">
                      ...
                      <div className="discover-content">
                        ...
                        <p className="ml-6 my-4 lg:-my-[37px] lg:ml-16 lg:pb-10 font-bold text-gray-500 text-[clamp(.5rem,4vw,14px)] md:leading-[25px]">
                          ...
                          choosing to ride a bike instead of drive, you can
                          reduce your carbon footprint and contribute to a
                          cleaner environment.
                        </p>
                      </div>
                    </div>
              ...
              <div className="lg:grid lg:grid-cols-2 lg:mr-20 lg:pr-10 ">
                <div className="dicover flex flex-col gap-4 py-7 lg:gap-0 md:my-6 relative">
                  ...
                  <p className="my-3 lg:my-5 lg:text-lg">
                    ...
                    promoting sustainable transportation and fostering a love
                    for cycling in our community. We offer a wide range of
                    ...
                    the perfect bike, ensuring a comfortable and enjoyable
                    riding experience. Additionally, we provide professional
                    bike servicing and maintenance to keep your ride running
                    smoothly. Join us in our mission to create a greener,
                    healthier world through the joy of cycling!
                  </p>
                </div>
                <div></div>
