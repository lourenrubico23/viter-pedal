...
const ModalAddAboutImage1 = ({ itemEdit, setIsAdd, aboutData }) => {
  ...
  const initVal = {
    ...
    about_img_a: aboutData ? aboutData.about_img_a : "",
  };
      ...
      <div className="modal-content">
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            const data = {
              ...values,
              about_img_a: photo?.name || aboutData.about_img_a,
            };
                        ...
                        <img
                          src={
                            photo
                              ...
                              : devBaseImgUrl +
                                "/" +
                                aboutData?.data[0].about_img_a // check db
                          }
                          alt="Logo"
                      ...
                      <div className="btnImgUpload">
                        <button>
                          ...
                          <InputPhotoUpload
                            ...
                            title="Upload Logo"
                            onChange={(e) =>
                              handleChangePhoto(e, initVal.about_img_a)
                            }
                    ...
                    <button
                      ...
                      disabled={
                        ((mutation.isPending || !props.dirty) &&
                          photo === null) ||
                        photo === "" ||
                        initVal.about_img_a === photo?.name
                      }
                    >
