    ...
    <>
      ...
      >
        <div className="container">
          <div className="">
            <h2 className="text-[1.2rem] leading-7 text-center justify-center mx-auto w-[15rem] font-[montserrat-medium] pb-6 text-dark">
              {contactBannerData?.data[0].contact_banner_title
                ? contactBannerData?.data[0].contact_banner_title
                : "Lorem ipsum dolor sit amet consectetur"}
            </h2>
            <button className="bg-accent rounded-md text-dark px-5 py-2 font-bold font-[montserrat-light] text-[.8rem] hover:bg-buttonHover transition-all flex items-center gap-2 mx-auto">
